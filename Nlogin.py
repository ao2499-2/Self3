...
#==============================================================================#
                    ...
                    line.sendMessage(to, "เซลได้ทำงานมาเป็นเวลา\n {}".format(str(runtime)))
...
#==============FINNISHING PROTECT========================#
                ...
                if settings["เปิดข้อมูลติ้ก"] == True:
